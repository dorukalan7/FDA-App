...
import 'package:fda/app/presentation/vaccines/view/vaccinestatus.dart';
...
class Vaccinespage extends StatelessWidget {
  ...
  const Vaccinespage({required this.title, required this.imageUrl, super.key});

  void navigateToVaccinesPage(BuildContext context, String status) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => VaccineStatus(title: title, status: status),
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Boxx(
                  label: 'Continue',
                  onTap: () => navigateToVaccinesPage(context, 'Vaccines'),
                ),
              ),
            ],
          ),
