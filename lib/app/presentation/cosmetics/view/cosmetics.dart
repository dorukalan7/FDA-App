...
class Cosmetics extends StatelessWidget {
  ...
  const Cosmetics({required this.title, required this.imageUrl, super.key});

  void navigateToCosmeticPage(BuildContext context, String status) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => CosmeticStatuss(title: title, status: status),
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Boxx(
                  label: 'Cosmetic',
                  onTap: () => navigateToCosmeticPage(context, 'Cosmetic'),
                ),
              ),
            ],
          ),
