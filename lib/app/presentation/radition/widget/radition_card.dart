...
class RadiationCard extends StatefulWidget {
  ...
  const RadiationCard({super.key, required this.device});

  @override
  State<RadiationCard> createState() => _RadationCardState();
}

class _RadationCardState extends State<RadiationCard> {
