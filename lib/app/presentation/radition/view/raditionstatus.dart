...
import 'package:fda/view/medicaldevice/cubit/medical_device_cubit.dart';
import 'package:fda/view/medicaldevice/service/medicaldeviceservice.dart';
import 'package:fda/view/radition/widget/radition_card.dart';
...
class RadiationPage extends StatelessWidget {
  ...
  const RadiationPage({required this.title, required this.status, super.key});
        ...
        body: BlocBuilder<MedicalDeviceCubit, MedicalDeviceState>(
          builder: (context, state) {
            if (state is MedicalDeviceLoading) {
              ...
              final devices =
                  state.devices
                      .map((device) => MedicalDeviceModel.fromJson(device))
                      .toList();
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...devices
                          .map((device) => RadiationCard(device: device))
                          .toList(),
                    ],
                  ),
                ),
