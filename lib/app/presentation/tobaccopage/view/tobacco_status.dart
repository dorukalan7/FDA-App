import 'package:fda/view/tobaccopage/cubit/cubit.dart';
...
import 'package:fda/view/tobaccopage/widget/Tobacco_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class TobaccoStatuss extends StatefulWidget {
  final String title;
  final String status;

  const TobaccoStatuss({required this.title, required this.status, super.key});

  @override
  State<TobaccoStatuss> createState() => _TobaccoStatussState();
}

class _TobaccoStatussState extends State<TobaccoStatuss> {
  @override
