...
class CosmeticReportCard extends StatefulWidget {
  final TobaccoReport report;

  const CosmeticReportCard({super.key, required this.report});

  @override
  State<CosmeticReportCard> createState() => _CosmeticReportCardState();
}

class _CosmeticReportCardState extends State<CosmeticReportCard> {
